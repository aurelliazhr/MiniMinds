...
<body>
    <div class="container">
        <div class="Header">
            <a id="kembaliButton" href="/bentuk/pilihanbentuk.html">
        ...
        <div class="Objek">
            <button class="card" data-letter="A" onclick="playAudio('/assets/a.mp3')">
                <img src="/assets/Rectangle 788.png" width="240" height="245" alt="Huruf A">
            </button>
        </div>

        <div class="Next">
            <button><a href="{{route('bentuk1')}}">Lanjut!!!</a></button>
        </div>
    </div>
</body>
