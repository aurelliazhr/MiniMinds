...
<head>
    ...
    <link rel="stylesheet" href="Owarna1.css" />
...
<body class="Kotak">
    ...
    <div class="Objek">
        <img src="/assets/Rectangle 78.png" width="240" height="217" />
    </div>
    ...
    <script>
        ...
        lanjutButton.addEventListener('click', function() {
            window.location.href = "{{route('owarna2')}}";
        });
        ...
        pilihanButtons.forEach(function(button) {
            button.addEventListener('click', function() {
                ...
                if (selectedColor === 'blue') {
                    ...
                    Swal.fire('Benar!', 'Benda ini berwarna merah!', 'success');
                } else if (selectedColor === 'yellow') {
                    Swal.fire('Salah!', 'Benda ini bukan berwarna kuning, silahkan coba lagi!', 'error');
                }
            });
        });
    </script>
